<template>
                ...
                <form @submit.prevent="fazerLogin" class="flex flex-col gap-4">
                    <div class="flex flex-col gap-1">
                        ...
                        <input 
                            ...
                            :class="['border rounded-lg px-4 py-3 text-sm outline-none w-full', erro ? 'border-red-500 focus:border-red-500' : 'border-gray-300', 'focus:border-blue-600']"
                        />
                    </div>
    ...
    <div
        v-if="erro"
        class="absolute top-4 left-0 right-0 flex justify-center z-50"
    >
