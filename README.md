...
Durante o desenvolvimento serão produzidos os seguintes artefatos:

- Levantamento de requisitos funcionais e não funcionais
- Definição de regras de negócio
- Modelagem do fluxo do sistema
- Definição de perfis e permissões
- Modelagem do banco de dados
- Arquitetura da API REST
- Versionamento e organização do código

Esses artefatos garantem **organização, rastreabilidade e qualidade no desenvolvimento do sistema**.
...
- Arthur Peixoto Lacerda  
- Enzo Zaia Soares  
- Guilherme Henrique Cavarsan  
- Octavio Thim Dias  
- Rodolfo Henrique Ribeiro Zanchetta  

---

# 📄 Licença

Projeto acadêmico desenvolvido para fins educacionais no curso de **Sistemas de Informação**.
